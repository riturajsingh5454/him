...
const Login = () => {
  return (
   ...
   <div class="flex flex-col items-center   py-10 mx-auto md:h-screen lg:py-10">
    
       <div class="w-full bg-white rounded-lg border border-gray-500 shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
           <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
               ...
               <form class="space-y-4 md:space-y-6" action="#">
                   ...
                   <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                       Don’t have an account yet? <Link href="/register"  class="font-medium text-blue-600 hover:underline dark:text-blue-500">Sign up</Link>
                   </p>
               </form>
           </div>
       </div>
